  ...
  return (
    ...
    >
      <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-12 h-full">
        ...
        <div className="w-full lg:w-1/2 flex justify-center md:justify-start ml-0 md:ml-2 mt-12 md:mt-20">
          <div
        ...
        <div className="text-left w-full md:w-1/2 mt-8 md:mt-0 px-0 sm:px-4">
